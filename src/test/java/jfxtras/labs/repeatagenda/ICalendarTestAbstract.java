...
public abstract class ICalendarTestAbstract
{
    ...
    protected static VEventImpl getYearly1()
    {
        ...
        vEvent.getDateTimeStart().setLocalDateTime(LocalDateTime.of(2015, 11, 9, 10, 0));
    ...
    {
        VEventImpl vEvent = new VEventImpl();
        vEvent.getDateTimeStart().setLocalDateTime(LocalDateTime.of(2015, 11, 6, 10, 0));
        vEvent.setAppointmentClass(clazz);
        RRule rule = new RRule();
        vEvent.setRRule(rule);
        Frequency yearly = new Yearly();
    ...
    {
        VEventImpl vEvent = new VEventImpl();
        vEvent.getDateTimeStart().setLocalDateTime(LocalDateTime.of(1997, 6, 5, 9, 0));
        vEvent.setAppointmentClass(clazz);
        RRule rule = new RRule();
        vEvent.setRRule(rule);
        Frequency yearly = new Yearly();
    ...
    {
        VEventImpl vEvent = new VEventImpl();
        vEvent.getDateTimeStart().setLocalDateTime(LocalDateTime.of(2015, 1, 6, 10, 0));
        vEvent.setAppointmentClass(clazz);
        RRule rule = new RRule();
        vEvent.setRRule(rule);
        Frequency yearly = new Yearly();
    ...
    {
        VEventImpl vEvent = new VEventImpl();
        vEvent.getDateTimeStart().setLocalDateTime(LocalDateTime.of(2015, 11, 10, 0, 0));
        vEvent.setAppointmentClass(clazz);
        RRule rule = new RRule();
        vEvent.setRRule(rule);
        Frequency yearly = new Yearly();
    ...
    {
        VEventImpl vEvent = new VEventImpl();
        vEvent.getDateTimeStart().setLocalDateTime(LocalDateTime.of(1996, 11, 5, 0, 0));
        vEvent.setAppointmentClass(clazz);
        RRule rule = new RRule();
        vEvent.setRRule(rule);
        Frequency yearly = new Yearly()
    ...
    {
        VEventImpl vEvent = new VEventImpl();
        vEvent.getDateTimeStart().setLocalDateTime(LocalDateTime.of(1997, 5, 19, 10, 0));
        vEvent.setAppointmentClass(clazz);
        RRule rule = new RRule();
        vEvent.setRRule(rule);
        Frequency yearly = new Yearly();
    ...
    {
        VEventImpl vEvent = new VEventImpl();
        vEvent.getDateTimeStart().setLocalDateTime(LocalDateTime.of(1997, 5, 12, 10, 0));
        vEvent.setAppointmentClass(clazz);
        RRule rule = new RRule();
        vEvent.setRRule(rule);
        Frequency yearly = new Yearly();
    ...
    {
        VEventImpl vEvent = new VEventImpl();
        vEvent.getDateTimeStart().setLocalDateTime(LocalDateTime.of(2015, 1, 1, 0, 0));
        vEvent.setAppointmentClass(clazz);
        RRule rule = new RRule();
        vEvent.setRRule(rule);
        Frequency yearly = new Yearly();
    ...
    {
        VEventImpl vEvent = new VEventImpl();
        vEvent.getDateTimeStart().setLocalDateTime(LocalDateTime.of(2015, 11, 29, 10, 0));
        vEvent.setAppointmentClass(clazz);
        RRule rule = new RRule();
        vEvent.setRRule(rule);
    ...
    {
        VEventImpl vEvent = new VEventImpl();
        vEvent.getDateTimeStart().setLocalDateTime(LocalDateTime.of(1997, 9, 2, 10, 0));
    ...
    {
        VEventImpl vEvent = new VEventImpl();
        vEvent.getDateTimeStart().setLocalDateTime(LocalDateTime.of(2015, 1, 10, 10, 0));
    ...
    {
        VEventImpl vEvent = new VEventImpl();
        vEvent.getDateTimeStart().setLocalDateTime(LocalDateTime.of(2015, 11, 11, 10, 0));
    ...
    {
        VEventImpl vEvent = new VEventImpl();
        vEvent.getDateTimeStart().setLocalDateTime(LocalDateTime.of(2015, 11, 7, 10, 0));
        vEvent.setAppointmentGroup(appointmentGroups.get(3));
        vEvent.setDurationInSeconds(2700L);
        vEvent.setDescription("Weekly1 Description");
        vEvent.setSummary("Weekly1 Summary");
    ...
    {
        VEventImpl vEvent = new VEventImpl();
        vEvent.getDateTimeStart().setLocalDate(LocalDate.of(2015, 11, 9));
        vEvent.setDurationInSeconds(3600L);
        vEvent.setAppointmentClass(clazz);
        return vEvent;
    }
