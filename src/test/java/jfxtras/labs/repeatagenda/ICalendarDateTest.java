...
//        Locale.setDefault(oldLocale);
    ...
    public void canFindRecurrenceSet1()
    {
        ...
        VEventImpl recurrence = vComponents.get(1);
    ...
    {
        List<VEventImpl> vComponents = getGoogleRepeatableParts();
        VEventImpl v0 = vComponents.get(0);
        VEventImpl v1 = vComponents.get(1);
        VEventImpl v2 = vComponents.get(2);
