...
public class ICalendarEditTest extends ICalendarTestAbstract2
{
//    /**
...
//        VEvent vComponentOriginal = new VEvent(vEvent);
//               
...
//
//        // Check edited VEvent
//        VEvent expectedVEvent = getDaily2()
//                .withDateTimeStart(LocalDateTime.of(2015, 11, 9, 9, 45))
//                .withDuration(Duration.ofMinutes(75))
//                .withSequence(1);
//
//        assertTrue(VEvent.isEqualTo(expectedVEvent, vEvent)); // check to see if repeat rule changed correctly
...
//        instances.addAll(newInstances);
//        assertEquals(3, instances.size()); // check if there are only 3 instances
//        VEvent vEventOriginal = new VEvent(vEvent);
//        
//        // apply changes
...
//        VEvent vEvent0 = (VEvent) vComponents.get(0);
//        VEvent vEvent1 = (VEvent) vComponents.get(1);
//        VEvent expectedVEvent0 = getDaily2()
//                .withRRule(new RecurrenceRule2()
//                        .withCount(6)
//                        .withFrequency(new Daily().withInterval(3))
//                        .withRecurrences(vEvent1));
//        assertTrue(VEvent.isEqualTo(expectedVEvent0, vEvent0));
//        
//        VEvent expectedVEvent1 = getDaily2()
...
//                .withRRule(null)
//                .withSequence(1);
//        assertTrue(VEvent.isEqualTo(expectedVEvent1, vEvent1));
//    }
//    
//    /**
...
//        VEvent vEvent0 = (VEvent) vComponents.get(0);
//        VEvent vEvent1 = (VEvent) vComponents.get(1);
//        VEvent expectedVEvent0 = getDaily1()
//                .withRRule(new RecurrenceRule2()
...
//        assertTrue(VEvent.isEqualTo(expectedVEvent0, vEvent0));
//        
//        VEvent expectedVEvent1 = getDaily1()
...
//        assertEquals(expectedDates, madeDates);
//
//        VEvent expectedVEvent = getWeeklyZoned()
//                .withRRule(null)
...
//        assertTrue(VEvent.isEqualTo(expectedVEvent, vEvent));
//
//        VEvent expectedVEvent2 = getWeeklyZoned();
//        expectedVEvent2.getRRule().recurrences().add(vEvent);
//        assertTrue(VEvent.isEqualTo(expectedVEvent2, vEventOriginal));
//    }
//    
//    /**
...
//    {
//        // Individual InstanceMock
//        VEvent vEvent = getGoogleWithExDates();
//        List<VComponentDisplayable<?>> vComponents = new ArrayList<>(Arrays.asList(vEvent));
...
//        assertEquals(expectedDates, madeDates);
//
//        VEvent expectedVEvent = getGoogleWithExDates()
//                .withRRule(null)
...
//        assertTrue(VEvent.isEqualTo(expectedVEvent, vEvent));
//
//        VEvent expectedVEvent2 = getGoogleWithExDates()
...
//    {
//        VEvent vEvent = getGoogleRepeatable();
//        List<VComponentDisplayable<?>> vComponents = new ArrayList<>(Arrays.asList(vEvent));
...
//        assertTrue(VEvent.isEqualTo(expectedVEvent, vEvent));
//
//        VEvent expectedVEvent2 = getGoogleRepeatable();
//        expectedVEvent2.getRRule().recurrences().add(vEvent);
//        assertTrue(VEvent.isEqualTo(expectedVEvent2, vEventOriginal));
//        
//        // apply changes
//        VEvent vEventOriginal2 = new VEvent(vEventOriginal);
...
//    {
//        List<VComponentDisplayable<?>> vComponents = getRecurrenceSetDaily1();
//        VEvent vEvent = (VEvent) vComponents.get(0);
...
//        List<VEvent> vComponents = new ArrayList<>(Arrays.asList(vEvent));
//        Temporal start = LocalDateTime.of(2015, 11, 8, 0, 0);
//        Temporal end = LocalDateTime.of(2015, 11, 15, 0, 0);
//        List<Appointment> instances = new ArrayList<>();
//        List<Appointment> newInstances = ICalendarAgendaUtilities.makeAppointments(vComponents, start, end);
//        instances.addAll(newInstances);
//        assertEquals(2, instances.size());
//        VEvent vEventOriginal = new VEvent(vEvent);
//        
//        // apply changes
//        vEvent.setRecurrenceRule(new RecurrenceRule3()
...
//        assertEquals(expectedDates, madeDates);
//        
//        VEvent expectedVEvent = getWeekly2()
