...
public class FormatType extends ParameterBase<FormatType, String>
{
    ...
    public void setValue(String value)
    {
        if (typeName == null)
        {
            typeName = new SimpleStringProperty(this, PropertyElement.FORMAT_TYPE.toString() + "_TYPE_NAME");
        }
        if (subtypeName == null)
        {
            subtypeName = new SimpleStringProperty(this, PropertyElement.FORMAT_TYPE.toString() + "_SUBTYPE_NAME");
        }
