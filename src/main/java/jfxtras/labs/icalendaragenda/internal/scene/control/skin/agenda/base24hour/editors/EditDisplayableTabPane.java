 ...
 * @param <U> subclass of {@link EditDescriptiveVBox} associated with the subclass of {@link VDisplayableBase}
 */
public abstract class EditDisplayableTabPane<T extends VDisplayableBase<T>, U extends EditDescriptiveVBox<T>> extends TabPane
{
