package jfxtras.labs.icalendaragenda.scene.control.agenda.editors;
...
public enum ChangeDialogOption
{
  ...
  , CANCEL;                                 // do nothing
     ...
     * 
     * @param vComponentOriginal  clone of unedited {@link VDisplayableBase}
     * @param vComponentEdited  edited {@link VDisplayableBase} (only descriptive properties are edited, date/time properties are not edited)
     ...
     * @see Reviser
     */
   public static <U extends VDisplayableBase<U>> Map<ChangeDialogOption, Pair<Temporal,Temporal>> makeDialogChoices(
    ...
    * Produce the map of change dialog options and the date range the option affects
    * 
    * @param vComponent   {@link VDisplayableBase} to be deleted
