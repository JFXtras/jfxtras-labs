...
public class VJournal<T> extends VComponentBaseAbstract<T>
{
    ...
    @Override
    public Collection<T> makeInstances(Temporal start, Temporal end) {
        // TODO Auto-generated method stub
        return null;
    }

    @Override
    public Collection<T> makeInstances() {
        // TODO Auto-generated method stub
        return null;
    }
