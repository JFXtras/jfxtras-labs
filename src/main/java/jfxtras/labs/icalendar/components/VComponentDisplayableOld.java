 ...
 * @author David Bal
 * */
public interface VComponentDisplayableOld<I>
{
    /**
...
//    void setCommentText(String value);
    ...
    VComponentDisplayableOld<I> getParent();
    void setParent(VComponentDisplayableOld<I> v);
...
//    void setSummary(String value);
    ...
    void copyTo(VComponentDisplayableOld<I> destination);
     ...
     */
    final static Comparator<? super VComponentDisplayableOld<?>> VCOMPONENT_COMPARATOR = (v1, v2) -> 
    {
     ...
     * @return
     */
    static <U> List<VComponentDisplayableOld<U>> findRelatedVComponents(Collection<VComponentDisplayableOld<U>> vComponents, VComponentDisplayableOld<U> vComponent)
    {
    ...
    static <U> List<VComponentDisplayableOld<U>> findRelatedVComponents2(Collection<VComponentDisplayableOld<U>> vComponents, VComponentDisplayableOld<U> vComponent)
    {
     ...
     * @return
     */
    static <U> int countVComponents(Collection<VComponentDisplayableOld<U>> relatives)
    {        
        int count=0;
        Iterator<VComponentDisplayableOld<U>> i = relatives.iterator();
        while (i.hasNext())
        {
