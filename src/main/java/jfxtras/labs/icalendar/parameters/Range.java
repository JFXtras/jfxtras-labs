...
public class Range extends ParameterBase<Range, RecurrenceIdentifier>
{
    ...
    public Range()
    {
        super(RecurrenceIdentifier.THIS_AND_FUTURE);
    }
    ...
    public Range(String content)
    {
        ...
        if (getValue() == RecurrenceIdentifier.UNKNOWN)
        {
    ...
    {
        String value = (getValue() == RecurrenceIdentifier.UNKNOWN) ? unknownValue : getValue().toString();
    ...
    public enum RecurrenceIdentifier
    {
        ...
        {
            RecurrenceIdentifier type = enumFromNameMap.get(propertyName.toUpperCase());
